...
export type DeleteDemarcheReviewMutation = {
  __typename?: 'Mutation';
  deleteDemarcheReview: boolean;
};
...
export class DeleteDemarcheReviewGQL extends Apollo.Mutation<
  DeleteDemarcheReviewMutation,
  DeleteDemarcheReviewMutationVariables
> {
